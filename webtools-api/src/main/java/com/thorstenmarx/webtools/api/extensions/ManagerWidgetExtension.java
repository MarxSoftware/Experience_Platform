...
/**
 * ExtensionPoint to create dashboard widgets.
 *
 * @author marx
 */
public abstract class ManagerWidgetExtension extends BaseExtension<ModuleContext> {

	/**
	 * Returns an array of widgets.
	 * @return Array of Widgets.
	 */
	abstract public Widget[] getWidgets ();
}
