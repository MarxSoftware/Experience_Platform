...
public interface MessageService {
	...
	void publish(final Message message) throws IOException;

	void registerMessageListener(final MessageListener listener);

	void unregisterMessageListener(final MessageListener listener);
