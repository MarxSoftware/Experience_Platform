...
public class SignInPanel extends Panel {
	...
	/**
	 * @param rememberMe If true, rememberMe will be enabled (username and password will be
	 * persisted somewhere)
	 */
	...
	public final class SignInForm extends StatelessForm<SignInPanel> {
		...
		public SignInForm(final String id) {
			...
			add(new TextField<>("username").setRequired(true).add(new AttributeAppender("autofocus", "")));
