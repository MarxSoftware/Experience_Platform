 ...
 * @author marx
 */
public class OrderITCase extends AbstractAudiencesTest {
	...
	public void create_segment() throws IOException {
		...
		AUDIENCES.create(Segments.NO_ORDER, true);
		AUDIENCES.create(Segments.AT_LEAST_ONE_ORDER, true);
	}
	...
	public void test_segments_no_coupons() throws IOException {
		...
		Assertions.assertThat(segments).containsExactly(Segments.NO_ORDER.getWpid());
	}
	...
	public void get_segments() throws IOException, InterruptedException {
		...
		Assertions.assertThat(segments).containsExactly(Segments.AT_LEAST_ONE_ORDER.getWpid());
	}
}
