package com.thorstenmarx.webtools.jgroups.demo;
...
/**
 * Demo of CounterService. When integrating with JGroups, this class should be
 * removed and the original demo in JGroups should be modified to accept
 * different CounterService implementations.
 */
public class CounterServiceDemo1 {
	...
	public static void main(final String[] args) throws Exception {
		...
		new CounterServiceDemo1().start(properties, name, repl_timeout, allow_dirty_reads, follower);
